...
def log(txt, type, states):
    with open('./logs/vi/result_env_{}_{}.log'.format(lamb, type), 'a') as f:
        f.write(txt + '\n')
    print(txt)
...
def run_vi():
    ...
    for s in [6, 8,10, 12, 14]:
        ...
        try:
            ...
            log_list('{}'.format(states) + '\tTD\t{}\t{}', 'diffs', diffs_shen, states)
            log_list_2('{}'.format(states) + '\tTD\t{}\t{}', 'vso', V_history_shen, env.s0, states)
            log_list('{}'.format(states) + '\tTD\t{}\t{}', 'us', utilities_shen, states)
            log_list('{}'.format(states) + '\tTD\t{}\t{}', 'us_min', utilities_min_shen, states)
        except (ValueError, OverflowError):
            steps_shen = - 1
            safe_points_shen = -1
            print('Error TD alpha {}, lamb {}'.format(states, lamb))
        ...
        try:
            ...
            log_list('{}'.format(states) + '\tTD_TRUNC\t{}\t{}', 'diffs', diffs_shen_trunc, states)
            log_list_2('{}'.format(states) + '\tTD_TRUNC\t{}\t{}', 'vso', V_history_shen_trunc, env.s0, states)
            log_list('{}'.format(states) + '\tTD_TRUNC\t{}\t{}', 'us', utilities_shen_trunc, states)
            log_list('{}'.format(states) + '\tTD_TRUNC\t{}\t{}', 'us_min', utilities_min_shen_trunc, states)
        except (ValueError, OverflowError):
            steps_shen_trunc = - 1
            safe_points_shen_trunc = -1
            print('Error TD_TRUNC alpha {}, lamb {}'.format(states, lamb))
        ...
        try:
            ...
            log_list('{}'.format(states) + '\tSI\t{}\t{}', 'diffs', diffs_soft, states)
            log_list_2('{}'.format(states) + '\tSI\t{}\t{}', 'vso', V_history_soft, env.s0, states)
            log_list('{}'.format(states) + '\tSI\t{}\t{}', 'us', utilities_soft, states)
            log_list('{}'.format(states) + '\tSI\t{}\t{}', 'us_min', utilities_min_soft, states)
        except (ValueError, OverflowError):
            steps_soft = - 1
            safe_points_soft = -1
            print('Error TD alpha {}, lamb {}'.format(states, lamb))
        ...
        log('{}\t{}\t{}\t{}\t{}\t{}'.format(states,0, steps_2, steps_shen, steps_soft, steps_shen_trunc), 'steps', states)

        log('{}\t{}\t{}\t{}\t{}\t{}'.format(states, 0, safe_points_2, safe_points_shen, safe_points_soft, safe_points_shen_trunc), 'safe', states)

        log_list('{}'.format(states) + '\tTarget\t{}\t{}', 'diffs', diffs_2, states)
        log_list_2('{}'.format(states) + '\tTarget\t{}\t{}', 'vso', V_history_2, env.s0, states)
        log_list('{}'.format(states) + '\tTarget\t{}\t{}', 'us', utilities_2, states)
        log_list('{}'.format(states) + '\tTarget\t{}\t{}', 'us_min', utilities_min_2, states)
