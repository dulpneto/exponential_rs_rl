...
UNDERFLOW_THRESHOLD = 0

#RUN_FOR = 'ql2'
RUN_FOR = 'dqn2'

def log(txt, type, bellman_update, alpha):
    fpath = './logs/{}/result_reward4_{}_{}.log'.format(RUN_FOR, alpha, type)
    ...
    for sample in range(1, samples + 1):
        ...
        for l in range(-15, 16, 1):
            ...
            for episode in range(1, train_episodes+1):
                ...
                model.bellman.under_count = 0
                model.bellman.not_under_count = 0
                ...
                while not done:
                    ...
                    if steps_to_update_target_model % 4 == 0 or done:
                        try:
                            ...
                            log('{}\t{}\t{}\t{}'.format(lamb, bellman_update, episode, 1), 'underflow', bellman_update,
                                alpha)
                            error = True
                            break
            ...
            if len(policy_stack[env.s0]) > 0:
                ...
                if proper_policy:
                    ...
                    if bellman_update == 'Target'and (model.bellman.not_under_count == 0 or model.bellman.under_count/model.bellman.not_under_count > 0.2):
...
def main():
    try:
        ...
        # Building environment
        env = RiverCrossingEnv(shape, state_as_img=False, max_abs_r=100)
